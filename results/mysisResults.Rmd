...
```{r plotCount, echo=FALSE, warning=FALSE, message=FALSE}
ggplot(data=data, aes(count)) + geom_histogram() + facet_grid(net ~ .) + 
  ggtitle("Histogram of normalized counts by net size")
...
```{r plot SexCount, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r plotJuviCount, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r plotLength, echo=FALSE, warning=FALSE, message=FALSE}
ggplot(data=data, aes(y)) + geom_histogram() + facet_grid(net ~ date) + 
  ggtitle("Histogram of lengths by net size")
ggplot(data=data, aes(y)) + geom_histogram() + facet_grid(net ~ gender) + 
  ggtitle("Histogram of lengths by sex and net size")
ggplot(data=data, aes(y)) + geom_histogram() + facet_grid(date ~ gender) + 
  ggtitle("Histogram of lengths by sex and date")
```
